...
def process_bill():
    ...
    return jsonify({'success': False, 'message': 'Automated receipt processing has been removed from FinTrack.'}), 410
...
def categorize_expense():
    ...
    return jsonify({'success': False, 'message': 'Automated categorization has been removed from FinTrack.'}), 410
